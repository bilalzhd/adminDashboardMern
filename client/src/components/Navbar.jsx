...
import { AppBar, Toolbar, IconButton, useTheme, InputBase, Button, Typography, Box, Menu, MenuItem } from "@mui/material";
            ...
            {/* RIGHT SIDE */}
                <FlexBetween gap="1.5rem">
                    ...
                    <FlexBetween>
                        ...
                        <Box component='img' alt='profile' src={profileImage} height='32px' width='32px' borderRadius='50px' sx={{objectFit: 'cover'}} />
                        <Box textAlign='left'>
